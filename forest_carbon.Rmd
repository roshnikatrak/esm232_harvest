...
# set initial forest size of 10 kg/C
forest_initial=10

# set parameters 
# thresh = canopy closure threshold of 50 kgC
# K = 250 kg C (carrying capacity)
# r = 0.01 (exponential growth rate before before canopy closure)
# g = 2 kg/year (linear growth rate after canopy closure)
metrics = list(K=250, r=0.01, g=2, thresh=50)

# plug parameters into the ODE solver
...
# visualize forest growth
ggplot(as.data.frame(growth),aes(time, carbon)) +
  geom_line() +
  labs(title = "Forest Growth Model",
       x = "time (years)",
       y = "Forest Size (units of carbon") +
  theme_bw()
```
