...
metrics = list(r = as.data.frame(sens_C$X[1,"r"]),
               K = as.data.frame(sens_C$X[1,"K"]),
               g = as.data.frame(sens_C$X[1,"g"]),
               canopy_threshold = as.data.frame(sens_C$X[1, "canopy_threshold"]))
